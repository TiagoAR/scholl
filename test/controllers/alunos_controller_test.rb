...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { endereco: @aluno.endereco, nome: @aluno.nome, nota1: @aluno.nota1, nota2: @aluno.nota2, nota3: @aluno.nota3, nota4: @aluno.nota4, serie: @aluno.serie, turma: @aluno.turma }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { endereco: @aluno.endereco, nome: @aluno.nome, nota1: @aluno.nota1, nota2: @aluno.nota2, nota3: @aluno.nota3, nota4: @aluno.nota4, serie: @aluno.serie, turma: @aluno.turma }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
